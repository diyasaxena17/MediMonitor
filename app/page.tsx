  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-white p-8">
      <div className="max-w-4xl w-full text-center space-y-12">
        ...
        {/* Large button - high contrast, accessible */}
        <button
          onClick={handleTookMedication}
          className="w-full max-w-2xl mx-auto py-12 px-16 bg-black text-white text-4xl md:text-5xl font-bold rounded-3xl hover:bg-gray-800 active:bg-gray-900 transition-all transform hover:scale-105 active:scale-95 shadow-2xl"
